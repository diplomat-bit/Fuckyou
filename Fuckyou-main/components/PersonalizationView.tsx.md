...
This component is part of the core UI suite, utilizing the following architectural assets:
- `api/ai.ts`: For heuristic theme generation.
- `context/PortalContext.tsx`: To persist aesthetic state across the application.
- `components/Header.tsx`: To reflect theme changes in the global navigation.
- `utils/ai-agent-factory.ts`: To instantiate the creative design agent.
---