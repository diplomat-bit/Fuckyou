...
import { Share2, Lock, Smartphone, ShieldCheck, ArrowRight, RefreshCw, Database, Globe, Zap } from 'lucide-react';
    ...
    <div className="space-y-12 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="space-y-8">
           ...
           <Card title="Mesh Infrastructure" icon={<Database className="w-5 h-5 text-purple-400" />}>
              <div className="space-y-4 pt-4">
                 <div className="flex items-center gap-3 p-3 bg-gray-950 rounded-xl border border-gray-800">
                    <Globe className="w-4 h-4 text-purple-400" />
                    <span className="text-xs font-bold text-white">Sovereign Ledger Sync</span>
                 </div>
                 <div className="flex items-center gap-3 p-3 bg-gray-950 rounded-xl border border-gray-800">
                    <Zap className="w-4 h-4 text-yellow-400" />
                    <span className="text-xs font-bold text-white">Real-time FAPI Stream</span>
                 </div>
              </div>
           </Card>
